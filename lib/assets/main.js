export function init(ctx, payload) {
  ...
  ctx.handleEvent("update", (values) => {
    ...
    cpuUtilEl.value == values[0] > 5 ? document.documentElement.style.setProperty('--cpuwarning', 'black') : '#E06C75';
    cpuUtilEl.value == values[0] > 80 ? document.documentElement.style.setProperty('--cpuwarning', 'red') : '#E06C75';

    memUtilEl.value == values[2] > 5 ? document.documentElement.style.setProperty('--memwarning', 'black') : '#98C379';
